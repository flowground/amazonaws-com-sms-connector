# ![LOGO](logo.png) AWS Server Migration Service MSP Connector

## Description

A generated MSP connector for the AWS Server Migration Service API (version 2016-10-24).
...
flowground :- Telekom iPaaS / amazonaws-com-sms-connector<br/>
